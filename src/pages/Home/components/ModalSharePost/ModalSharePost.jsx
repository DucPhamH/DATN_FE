...
export default function ModalSharePost({ handleCloseSharePost, post }) {
  ...
  return (
    <div className='modal-customs'>
      <div className='overlay-customs' onClick={handleCloseSharePost}></div>
      <div className='modal-content max-h-[90%] min-w-[360px] md:min-w-[450px] dark:bg-gray-900 bg-white'>
