  ...
  return (
    <div className=' grid xl:mx-10 xl:gap-12 xl:grid-cols-5'>
      <div className='col-span-3'>
        <div className='bg-white py-2 px-4 mt-2 shadow md:rounded-md dark:bg-slate-800'>
          <div>{checkTime()}</div>
          <div className='flex justify-between items-center gap-2 md:gap-4 w-full'>
            ...
            <div className='bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-950 w-[90%] md:w-full cursor-pointer hover:bg-slate-200 transition-all h-10   md:h-12 my-4 flex items-center rounded-full'>
