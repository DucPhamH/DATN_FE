...
export default function PostCard() {
  return (
    <article className='mb-4 break-inside md:px-6 py-6 md:rounded-md bg-white dark:bg-slate-800 flex flex-col bg-clip-border'>
      <div className='flex pb-4 px-4 md:px-0 items-center justify-between'>
        <div className='flex'>
          <a className='inline-block mr-4' href='#'>
            <img className='rounded-full max-w-none w-14 h-14' src={useravatar} />
          </a>
      ...
      <h2 className='text-xl px-4 md:px-0 font-extrabold'>Món bún đậu</h2>
      <div className='py-4'>
