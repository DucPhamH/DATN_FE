...
export default function SearchFood() {
  ...
  return (
    <div
      className={`flex relative cursor-pointer text-orange-700 dark:text-gray-300 hover:text-black dark:hover:text-red-300 justify-between items-center px-2  lg:text-lg transition-colors duration-150 my-1 lg:m-2 rounded-lg`}
      ref={ref}
    >
