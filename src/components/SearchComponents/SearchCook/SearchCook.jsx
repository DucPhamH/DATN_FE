...
export default function SearchCook() {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          className='z-[999] border dark:border-gray-700 top-6 lg:top-10 right-[calc(-40%+4px)] max-h-64 overflow-y-auto scrollbar-thin scrollbar-track-white dark:scrollbar-track-[#010410] dark:scrollbar-thumb-[#171c3d] scrollbar-thumb-slate-100  lg:left-0 absolute
