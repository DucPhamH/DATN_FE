...
export default function SearchRegions() {
  ...
  return (
    <div
      className={`flex relative cursor-pointer text-green-700 dark:text-gray-300 hover:text-black dark:hover:text-red-300 justify-between items-center px-2  lg:text-lg transition-colors duration-150 my-1 lg:m-2 rounded-lg`}
      ref={ref}
    >
      <div className='flex justify-center items-center' onClick={() => setOpen(!open)}>
        <div className='pr-1 text-sm font-medium lg:pr-2'>Vùng miền</div>
