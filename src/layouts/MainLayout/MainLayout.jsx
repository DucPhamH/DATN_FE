...
export default function MainLayout({ children }) {
  return (
    ...
    //   </div>
    // </div>
    <div className='flex justify-between max-h-full dark:text-gray-300 dark:bg-color-primary-dark'>
      <SideBar />
      <div className='md:ml-64  w-full'>
        <Header />
        <div className='mt-20 h-screen dark:bg-color-primary-dark'>{children}</div>
      </div>
    </div>
  )
}
